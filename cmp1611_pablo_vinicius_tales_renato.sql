...
--
-- Name: cmp1611_trabalho_final; Type: SCHEMA; Schema: -; Owner: user
--

CREATE SCHEMA cmp1611_trabalho_final;


ALTER SCHEMA cmp1611_trabalho_final OWNER TO "user";
...
--
-- Name: motorista_veiculo; Type: TABLE; Schema: cmp1611_trabalho_final; Owner: user
--
...
ALTER TABLE cmp1611_trabalho_final.motorista_veiculo OWNER TO "user";

--
-- Name: motoristas; Type: TABLE; Schema: cmp1611_trabalho_final; Owner: user
--
...
ALTER TABLE cmp1611_trabalho_final.motoristas OWNER TO "user";

--
-- Name: passageiros; Type: TABLE; Schema: cmp1611_trabalho_final; Owner: user
--
...
ALTER TABLE cmp1611_trabalho_final.passageiros OWNER TO "user";

--
-- Name: pessoas; Type: TABLE; Schema: cmp1611_trabalho_final; Owner: user
--
...
ALTER TABLE cmp1611_trabalho_final.pessoas OWNER TO "user";

--
-- Name: proprietarios; Type: TABLE; Schema: cmp1611_trabalho_final; Owner: user
--
...
ALTER TABLE cmp1611_trabalho_final.proprietarios OWNER TO "user";

--
-- Name: tipo_pagto; Type: TABLE; Schema: cmp1611_trabalho_final; Owner: user
--
...
ALTER TABLE cmp1611_trabalho_final.tipo_pagto OWNER TO "user";

--
-- Name: veiculo; Type: TABLE; Schema: cmp1611_trabalho_final; Owner: user
--
...
ALTER TABLE cmp1611_trabalho_final.veiculo OWNER TO "user";

--
-- Name: viagem; Type: TABLE; Schema: cmp1611_trabalho_final; Owner: user
--
...
CREATE TABLE cmp1611_trabalho_final.viagem (
    ...
    CONSTRAINT viagem_forma_pagto_check CHECK (((forma_pagto)::text = ANY ((ARRAY['DINHEIRO'::character varying, 'CARTAO'::character varying, 'POSTERIORI'::character varying])::text[])))
);


ALTER TABLE cmp1611_trabalho_final.viagem OWNER TO "user";

--
-- Data for Name: motorista_veiculo; Type: TABLE DATA; Schema: cmp1611_trabalho_final; Owner: user
--
...
--
-- Data for Name: motoristas; Type: TABLE DATA; Schema: cmp1611_trabalho_final; Owner: user
--
...
--
-- Data for Name: passageiros; Type: TABLE DATA; Schema: cmp1611_trabalho_final; Owner: user
--
...
--
-- Data for Name: pessoas; Type: TABLE DATA; Schema: cmp1611_trabalho_final; Owner: user
--
...
--
-- Data for Name: proprietarios; Type: TABLE DATA; Schema: cmp1611_trabalho_final; Owner: user
--
...
--
-- Data for Name: tipo_pagto; Type: TABLE DATA; Schema: cmp1611_trabalho_final; Owner: user
--
...
--
-- Data for Name: veiculo; Type: TABLE DATA; Schema: cmp1611_trabalho_final; Owner: user
--

COPY cmp1611_trabalho_final.veiculo (placa, marca, modelo, ano_fabric, capacidade_pass, cor, tipo_combust, potencia_motor) FROM stdin;
\.


--
-- Data for Name: viagem; Type: TABLE DATA; Schema: cmp1611_trabalho_final; Owner: user
--
...
--
-- Name: motorista_veiculo motorista_veiculo_pkey; Type: CONSTRAINT; Schema: cmp1611_trabalho_final; Owner: user
--
...
--
-- Name: motoristas motoristas_pkey; Type: CONSTRAINT; Schema: cmp1611_trabalho_final; Owner: user
--
...
--
-- Name: passageiros passageiros_pkey; Type: CONSTRAINT; Schema: cmp1611_trabalho_final; Owner: user
--
...
--
-- Name: pessoas pessoas_pkey; Type: CONSTRAINT; Schema: cmp1611_trabalho_final; Owner: user
--
...
--
-- Name: proprietarios proprietarios_pkey; Type: CONSTRAINT; Schema: cmp1611_trabalho_final; Owner: user
--
...
--
-- Name: tipo_pagto tipo_pagto_pkey; Type: CONSTRAINT; Schema: cmp1611_trabalho_final; Owner: user
--
...
--
-- Name: veiculo veiculo_pkey; Type: CONSTRAINT; Schema: cmp1611_trabalho_final; Owner: user
--
...
--
-- Name: viagem viagem_pkey; Type: CONSTRAINT; Schema: cmp1611_trabalho_final; Owner: user
--
...
--
-- Name: motorista_veiculo motorista_veiculo_cpf_motorista_fkey; Type: FK CONSTRAINT; Schema: cmp1611_trabalho_final; Owner: user
--
...
--
-- Name: motorista_veiculo motorista_veiculo_placa_veiculo_fkey; Type: FK CONSTRAINT; Schema: cmp1611_trabalho_final; Owner: user
--
...
--
-- Name: viagem viagem_cpf_mot_viag_fkey; Type: FK CONSTRAINT; Schema: cmp1611_trabalho_final; Owner: user
--
...
--
-- Name: viagem viagem_cpf_pass_viag_fkey; Type: FK CONSTRAINT; Schema: cmp1611_trabalho_final; Owner: user
--
...
--
-- Name: viagem viagem_placa_veic_viag_fkey; Type: FK CONSTRAINT; Schema: cmp1611_trabalho_final; Owner: user
--
