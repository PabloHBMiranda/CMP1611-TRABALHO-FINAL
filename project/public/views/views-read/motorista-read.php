...
<table class="read">
	...
	foreach ( $motoristas as $motorista ) {
		...
		echo "<td>";
		echo "<a href='../views-updates/motorista-update.php?cpf={$motorista['cpf_motorista']}'>Editar</a>";
		echo "<a href='../views-updates/motorista-update.php?cpf={$motorista['cpf_motorista']}'>Excluir</a>";
		echo "</td>";
		echo "</tr>";
	}
	?>
